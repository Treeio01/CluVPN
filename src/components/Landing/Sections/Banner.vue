<template>
  <div
    class="flex w-full gap-[10px] sm:flex-row flex-col bg-primary mt-[50px] mobile:mt-[66px] 1025:mt-[88px] rounded-[60px] justify-between max-w-[370px] mobile:max-w-[924px] 1025:max-w-[1275px] py-[10px] mobile:py-[36px] px-[44px] mobile:px-[34px] 1025:px-[38px]"
    data-aos="fade-up"
