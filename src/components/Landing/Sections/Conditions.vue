<template>
  ...
  >
    <h1
      class="text-black font-Golos text-center font-semibold text-[20px] mobile:text-[35px] 1025:text-[40px] leading-normal lg:leading-[19px] tracking-0"
      data-aos="fade-down"
      data-aos-duration="700"
    >
    ...
    >
      ...
      />
      <span
        class="text-white font-Golos max-w-[883px] font-bold text-[26px] mobile:text-[37px] 1025:text-[44px] leading-normal lg:leading-[29px] tracking-0"
        data-aos="fade-right"
        data-aos-delay="250"
        data-aos-duration="700"
      >
    ...
    <div
      class="flex  1025:flex-col flex-col w-full mt-[25px] mobile:mt-[73px] gap-[34px] 1025:gap-[56px]"
    >
      <div
      ...
      >
        ...
        >
          <img
            ...
            class="absolute 1400:flex hidden 1025:max-w-full mobile:max-w-[120px] mobile:top-[78px] 1025:top-[81px] mobile:right-[200px] 1025:right-[188px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="200"
            data-aos-duration="700"
          ...
          <img
            ...
            class="absolute 1400:flex hidden 1025:max-w-full mobile:max-w-[100px] mobile:top-[44px] 1025:top-[40px] mobile:right-[86px] 1025:right-[50px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="220"
            data-aos-duration="700"
          ...
          <img
            ...
            class="absolute 1400:flex hidden 1025:max-w-full mobile:max-w-[120px] mobile:top-[135px] 1025:top-[150px] mobile:right-[99px] 1025:right-[66px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="240"
            data-aos-duration="700"
          ...
          <img
            ...
            class="absolute 1400:flex hidden 1025:max-w-full mobile:max-w-[120px] mobile:top-[187px] 1025:top-[211px] mobile:right-[211px] 1025:right-[202px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="260"
            data-aos-duration="700"
          ...
          <img
            ...
            class="absolute 1400:flex hidden 1025:max-w-full mobile:max-w-[120px] mobile:top-[228px] 1025:top-[263px] mobile:right-[86px] 1025:right-[50px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="280"
            data-aos-duration="700"
          ...
          <div class="1400:hidden flex items-center justify-between mb-4.5">
            <img
              src="../../../assets/img/discord.png"
          ...
          <RouterLink
            to="/login"
            class="bg-primary cursor-pointer flex items-center justify-center max-w-[370px] py-[16px] mobile:py-[22px] w-full mobile:px-[22px] rounded-[22px] hover:bg-primary/75 transition-colors ease duration-300"
            data-aos="fade-up"
            data-aos-delay="500"
            data-aos-duration="700"
          >
        ...
        >
          <img
            ...
            class="absolute right-[-2px] sm:flex mobile:hidden mobile:right-[57px] 1025:right-[8px] bottom-[21px] mobile:bottom-[8px] 1025:bottom-[13px] rotate-[13deg] max-w-[110px] mobile:max-w-[187px] 1025:max-w-[212px]"
            alt=""
            data-aos="zoom-in"
            data-aos-delay="250"
            data-aos-duration="700"
      ...
      <div class="flex mobile:flex-col sm:flex-row flex-col  gap-[14px] mobile:gap-[28px] 1025:gap-[38px] w-full">
        <div
          class="flex w-full relative flex-col gap-[21px] mobile:gap-[21px] 1025:gap-[29px] sm:max-w-full max-w-[470px]  1025:max-w-[667px] bg-[#F5F7FA] rounded-[30px] mobile:rounded-[40px] 1025:rounded-[80px] pb-[56px] mobile:pb-[79px] 1025:pb-[182px] py-[30px]  mobile:py-[33px] 1025:py-[48px] pl-[39px] mobile:pl-[39px] 1025:pl-[56px] mobile:pr-[80px] 1025:pr-[77px]"
          data-aos="fade-up"
          data-aos-delay="250"
          data-aos-duration="700"
        >
